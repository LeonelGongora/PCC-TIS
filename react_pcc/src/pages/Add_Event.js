...
*/
    ...
    */
    ...
    handleInput = (e) => {
        ...
        if (e.target.name === "participantes_equipo" && e.target.value.trim() !== "") {
    ...
    handleSubmit = (event) => {
        ...
        if (this.state.fecha_fin.trim() === "") {
            ...
            this.setState({ advertenciaFechaFinEvento: !this.advertenciaFechaFinEvento });
        }
        if (this.state.participantes_equipo.trim() === "") {
            this.setState({ errorParticipantes: "Campo vacio" });
            this.setState({ advertenciaParticipantes: !this.advertenciaParticipantes });
        }
            ...
            <div className='crearEventos'>
                ...
                <div className='entradasDatos'>
                    <form onSubmit={this.saveEvent}>
                        ...
                        {this.state.advertenciaNombre && (<p className='advertencia'>Campo Obligatorio</p>)}    
                        ...
                        {this.state.advertenciaRequisitos && (<p className='advertencia'>Campo Obligatorio</p>)}    
                        ...
                        {this.state.advertenciaFechaInicio && (<p className='advertencia'>Campo Obligatorio</p>)}                    
                        
                        <div id={this.state.errorNumero ? 'error' : 'entrada'}>
                            <p id='textoCuadro'>Numero de Contacto</p>
                            <input id='inputRegistro' type="tel" maxLength={8} name="numero_contacto" placeholder="65487898" onChange={this.handleInput}  />
                        </div>
                        {this.state.advertenciaNumero && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        {this.state.advertenciaDescripcion && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        {this.state.advertenciaFechaLimite && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        {this.state.advertenciaFechaFinEvento && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        {this.state.advertenciaParticipantes && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        {this.state.advertenciaTipoEvento && (<p className='advertencia'>Campo Obligatorio</p>)}
                        ...
                        <div className='botonEnviar'>
                            <button onClick={this.handleSubmit} className='botonRegistrar' type="submit"> Registrarse</button>
                        </div>
                    </form>
