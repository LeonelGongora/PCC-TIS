...
import FormRegistroEvento_Equipos_Req from "../components/FormRegistroEvento_Equipos_Req";
...
function Register_to_Event_Team_Req() {
    ...
    <div className="App-Register-Event">
      ...
      <div className="contenedorRaisa">
          ...
          <div className="formulario">
            <FormRegistroEvento_Equipos_Req/>
          </div>
      </div>
    </div>
    </div>
...
export default Register_to_Event_Team_Req;